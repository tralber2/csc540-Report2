...
num VARCHAR(30) UNSIGNED NOT NULL,
hotel_id INT(6) UNSIGNED,
category VARCHAR(30) UNSIGNED NOT NULL,
...
hotel_id VARCHAR(30) UNSIGNED,
room_id INT(12) UNSIGNED,
room_num VARCHAR(30) UNSIGNED REFERENCES room(num),
...
INSERT INTO hotel (id, name, phone, address, city, manager_id ) VALUES ( '0001', 'Hotel A', '919', '21 ABC St, Raleigh NC 27', 'Raleigh', 100);
INSERT INTO hotel (id, name, phone, address, city, manager_id ) VALUES ( '0002', 'Hotel B', '718', '25 XYZ St, Rochester NY 54', 'Rochester', 101);
INSERT INTO hotel (id, name, phone, address, city, manager_id ) VALUES ( '0003', 'Hotel C', '984', '29 PQR St, Greensboro NC 27', 'Greensboro', 102);
INSERT INTO hotel (id, name, phone, address, city, manager_id ) VALUES ( '0004', 'Hotel D', '920', '28 GHW St, Raleigh NC 32', 'Raleigh', 105);

INSERT INTO room (id, num, hotel_id, category, max_occupancy, nightly_rate, availability) VALUES ( 1, '01', '0001', 'Economy', 1, 100, 1);
INSERT INTO room (id, num, hotel_id, category, max_occupancy, nightly_rate, availability) VALUES ( 2, '02', '0001', 'Deluxe', 2, 200, 1);
INSERT INTO room (id, num, hotel_id, category, max_occupancy, nightly_rate, availability) VALUES ( 3, '03', '0002', 'Economy', 1, 100, 1);
INSERT INTO room (id, num, hotel_id, category, max_occupancy, nightly_rate, availability) VALUES ( 4, '02', '0003', 'Executive', 3, 1000, 0);
INSERT INTO room (id, num, hotel_id, category, max_occupancy, nightly_rate, availability) VALUES ( 5, '01', '0004', 'Presidential', 4, 5000, 1);
INSERT INTO room (id, num, hotel_id, category, max_occupancy, nightly_rate, availability) VALUES ( 6, '05', '0001', 'Deluxe', 2, 200, 1);
...
INSERT INTO occupies (hotel_id, room_id, room_num, customer_id, number_of_guest, start_date, end_date, discount) VALUES ('0001', 1, '01', 1001, 1, STR_TO_DATE('5-10-2017 15:17:00','%m-%d-%Y %H:%i:%s'), STR_TO_DATE('5-13-2017 10:22:00','%m-%d-%Y %H:%i:%s'), 0);
INSERT INTO occupies (hotel_id, room_id, room_num, customer_id, number_of_guest, start_date, end_date, discount) VALUES ('0001', 2, '02', 1002, 2, STR_TO_DATE('5-10-2017 16:11:00','%m-%d-%Y %H:%i:%s'), STR_TO_DATE('5-13-2017 09:27:00','%m-%d-%Y %H:%i:%s'), 1);
INSERT INTO occupies (hotel_id, room_id, room_num, customer_id, number_of_guest, start_date, end_date, discount) VALUES ('0002', 3, '03', 1003, 1, STR_TO_DATE('5-10-2017 15:45:00','%m-%d-%Y %H:%i:%s'), STR_TO_DATE('5-14-2017 11:10:00','%m-%d-%Y %H:%i:%s'), 0);
INSERT INTO occupies (hotel_id, room_id, room_num, customer_id, number_of_guest, start_date, end_date, discount) VALUES ('0003', 4, '02', 1004, 2, STR_TO_DATE('5-10-2017 14:30:00','%m-%d-%Y %H:%i:%s'), STR_TO_DATE('5-12-2017 10:00:00','%m-%d-%Y %H:%i:%s'), 0);
...
INSERT INTO works_for (staff_id, hotel_id) VALUES (100, '0001');
INSERT INTO works_for (staff_id, hotel_id) VALUES (101, '0002');
INSERT INTO works_for (staff_id, hotel_id) VALUES (102, '0003');
INSERT INTO works_for (staff_id, hotel_id) VALUES (103, '0001');
INSERT INTO works_for (staff_id, hotel_id) VALUES (104, '0001');
INSERT INTO works_for (staff_id, hotel_id) VALUES (105, '0004');
INSERT INTO works_for (staff_id, hotel_id) VALUES (106, '0004');
